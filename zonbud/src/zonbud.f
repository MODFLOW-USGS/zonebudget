...
C     ------------------------------------------------------------------
      VERSON='ZONEBUDGET version 3.02'
C
...
C-----ADJUST CONSTANT-HEAD AND FACE FLOWS WITH SWI2 BUDGET TERMS IF 
C-----IF AVAILABLE - JDH 20160315      
      ...
      IF(TEXT.EQ.'      SWIADDTOCH') GO TO 200
      IF(TEXT.EQ.'     SWIADDTOFRF') GO TO 300
      IF(TEXT.EQ.'     SWIADDTOFFF') GO TO 400
      IF(TEXT.EQ.'     SWIADDTOFLF') GO TO 500
C
